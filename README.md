...
## Credits
- [@Yehonal](https://github.com/Yehonal),[@Helias](https://github.com/Helias) for original code and all the types they built out
- [@wartoshika](https://github.com/wartoshika) for building out all the types for WoW API
- [@Honey55](https://github.com/Honey55) for allowing me to post about it in Azeroth Discord Community
- [@manmadedrummer](https://github.com/manmadedrummer) for always testing my ets modules 
