...
declare const enum ZoneIdType {
   Borean_Tundra = 114,
   Crystalsong_Forest = 127,
   Dalaran = 125,
   Dalaran_Underbelly = 126,
   Dragonblight = 115,
   Grizzly_Hills = 116,
   Howling_Fjord = 117,
   Icecrown = 118,
   ...
   Wintergrasp = 123,
   Zul_Drak = 121,
   Outland_Twisting_Nether = 101,
   Blades_Edge_Mountains = 105,
   Hellfire_Peninsula = 100,
   Nagrand = 107,
   Netherstorm = 109,
   Shadowmoon_Valley = 104,
   Terrokkar_Forest = 108,
   Zangermarsh = 102,
   Shattrath = 111,
   Silvermoon = 110,
   Eversong_Woods = 94,
   Ghostlands = 95,
   Isle_of_Quel_Danas = 122,
   The_Exodar = 103,
   Azuremyst_Isle = 97,
   Bloodmyst_Isle = 106,
   Kalimdor = 12,
   ...
   Undercity = 90,
   Vashj_ir_Kelp_thar_Forest = 201,
   Vashj_ir_Shimmering_Expanse = 205,
   Vashj_ir_Abyssal_Depths = 204,
 ...
 * Returns a [Map] by ID.
 */
declare function GetMapById(this:void,mapId: number, instanceId?: number): EMap;
 ...
 */
declare function GetObjectGUID(this:void,lowguid: number, entry: number): number;
 ...
 */
declare function GetPlayerByName(this:void, name: string): Player;
 ...
 */
declare function PerformIngameSpawn(this:void,
  spawnType: number,
  entry: number,
  mapId: number,
  instanceId: number,
 ...
 */
declare function SendWorldMessage(this: void, message: string): void;
 ...
 */
declare function WorldDBExecute(this: void, sql: string): void;
 ...
 *     end
 */
declare function WorldDBQuery(this:void, sql: string): ElunaQuery;
...
declare class EMap {
  ...
  /**
     ...
     */
  GetWorldObject(guid: number): WorldObject | null;
